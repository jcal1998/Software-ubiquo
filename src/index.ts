...
function demonstrateIndividualAnalysis() {
    ...
    const normalBloodwork: Bloodwork = {
        id: "bw-1",
        patient: { name: "John Smith", cpf: "111.222.333-44", age: 45, sex: 'M', latitude: -16.7, longitude: -49.2, municipality_id: "5208707" },
        test_date: new Date(),
    ...
    const severeAnemiaBloodwork: Bloodwork = {
        id: "bw-2",
        patient: { name: "Maria Souza", cpf: "555.666.777-88", age: 62, sex: 'F', latitude: -16.7, longitude: -49.2, municipality_id: "5208707" },
        test_date: new Date(),
